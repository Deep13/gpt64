  ...
  return (
    <div className="flex h-[100vh] w-[100%]">
      ...
      <main className="bg-[#343541] w-full relative text-center">
        {!chatFeed[0] && (
          <div className="h-[100vh] text-center w-full text-6xl font-semibold text-[#40414F] flex items-center justify-center">
            Welcome to GPT_New
          </div>
        )}
        ...
        <div className="h-[22vh] w-full flex absolute left-0 bottom-0 justify-center items-center transparentGradient">
          <div className="p-1 w-[70%] bg-[#40414F] box-shadow rounded-md flex justify-between shadow-sm">
            <input
              type="text"
